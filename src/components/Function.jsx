    ...
    return ( 
        <section id="func">
            <div className="func_inner">
                ...
                <img className="imagefile" src={main} alt="a" width="15%" height="20%"/>
                <img className="imagefile" src={alert} alt="a" width="15%" height="20%"/>
                <img className="imagefile" src={register} alt="a" width="15%" height="20%"/>

            </div>
            <div className="func_inner">
            <img className="imagefile" src={ai} alt="a" width="40%" height="40%"/>
                <div className="func_desc">
                    <h3 className="func_title">AI 기술 활용</h3>
                    <p className="func_content">
                        온라인 쇼핑몰 및 해당 쇼핑몰의 물품 수는 상당합니다. <br></br>
                        해당 제품마다 다른 URI를 가지고 있으며, 더구나 그 수는 계속해서 증가하고 있습니다.<br></br>                       
                        따라서, 관련 정보를 저장 및 처리하기 위해 AI기술을 활용하여 자동화 시스템을 구축하였습니다.                            
            ...
            <div className="func_inner">
                <div className="func_desc">
                    <h3 className="func_title">사기 사이트 관련 API 제공</h3>
                    <p className="func_content">
                        ...
                        <br></br><br></br>
                        <strong>딱걸렸어와 제휴하기</strong>
                    </p>
                </div>
                <img className="imagefile" src={api} alt="a" width="35%" height="25%"/>
            </div>
            <div className="func_inner">
            <img className="imagefile" src={money} alt="a" width="30%" height="30%"/>
                <div className="func_desc">
                    <h3 className="func_title">무료 서비스 제공</h3>
                    <p className="func_content">
                        딱걸렸어(TGRS)는 민간 사용자를 대상으로는 서비스를 무료 제공합니다.
                        <br></br><br></br>
                        <strong>딱걸렸어 사용하러 가기</strong>
